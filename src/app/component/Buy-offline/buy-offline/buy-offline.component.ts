...
import { ExportOrderServiceService } from 'src/app/_service/export-service/export-order-service.service';
...
export class BuyOfflineComponent implements OnInit {
  ...
  checkoutAtTheCounter() {
    ...
    this.restOrder.checkoutAnOrderAtTheCounter(this.idOrder).subscribe(res => {
      ...
      // this.isLoading = false;
      // if (error == false) {
      //   return this.toast.error('Bạn chưa chọn san pham' });
      // }
      // this.toast.error('Bạn chưa chọn hóa đơn thanh toán' });
    });
  }
